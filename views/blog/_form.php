...
/* @var $model apologzy\blog\models\Blog */
...
<div class="blog-form">
    ...
    <div class="row">
        ...
        <?= $form->field($model, 'status_id',['options'=>['class'=>'col-xs-6']])->dropDownList(\apologzy\blog\models\Blog::STATUS_LIST) ?>
        ...
        <?= $form->field($model, 'tags_array',['options'=>['class'=>'col-xs-6']])->widget(\kartik\select2\Select2::classname(), [
            'data' => \yii\helpers\ArrayHelper::map(\apologzy\blog\models\Tag::find()->all(),'id','name'),
            'language' => 'ru',
            'options' => ['placeholder' => 'Выбрать tag ...',
                'multiple' => true,
            ],
            'pluginOptions' => [
                'allowClear' => true,
