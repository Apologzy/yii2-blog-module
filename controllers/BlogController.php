...
namespace apologzy\blog\controllers;

use common\models\ImageManager;
use Yii;
use apologzy\blog\models\BlogSearch;
...
class BlogController extends Controller
{
    ...
    {
        $model = new \apologzy\blog\models\Blog();
        $model->sort = 50 ;
    ...
    {
        if (($model = \apologzy\blog\models\Blog::find()->with('tags')->andWhere(['id'=> $id])->one()) !== null) {
            return $model;
        }
